<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-if="detailList.categoryView">{{detailList.categoryView.category1Name}}</span>
        <span v-if="detailList.categoryView">{{detailList.categoryView.category2Name}}</span>
        <span v-if="detailList.categoryView">{{detailList.categoryView.category3Name}}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName" v-if="detailList.skuInfo">{{detailList.skuInfo.name}}</h3>
            <p class="news" v-if="detailList.skuInfo">{{detailList.skuInfo.skuDesc}}</p>
            <div class="priceArea">
          ...
          <div class="choose">
            <div class="chooseArea" v-if="detailList.spuSaleAttrList">
              <div class="choosed"></div>
              <dl v-for="(spuSaleAttr,attrIndex) in detailList.spuSaleAttrList" :key="spuSaleAttr.id">
                <dt class="title">{{spuSaleAttr.saleAttrName}}</dt>

                <dd changepirce="0" :class="{active:value.isChecked===`1`}" 
                    v-for="(value,valueIndex) in spuSaleAttr.spuSaleAttrValueList" 
                    :key="valueIndex" @click="activeFn({attrIndex,valueIndex})">{{value.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
